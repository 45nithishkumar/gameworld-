...
function updateScore(playerWeapon, computerWeapon) {
  ...
  if (playerWeapon) {
    ...
    if (resultElem.innerHTML = 'You did not make a choice! | You lose the game!') {
  ...
  if (playerScore === 5) {
    ...
    resultElem.style.color = 'white';
    computerChoiceElem.innerHTML = 'Game Over';
    if (computerChoiceElem.innerHTML == 'Game Over') {
      para.style.display = 'none';
    }
    disableOptions();
    stopTimer();
...
function resetGame() {
  ...
  if (resultElem.innerHTML == 'Choose your weapon!') {
